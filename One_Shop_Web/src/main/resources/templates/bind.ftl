...
$(document).ready(function(){
	...
	$("#old_bind .dl_zc_title a").click(function (){
		$("#old_bind").hide();
		$("#new_bind").show();
	});
	
	$("#new_bind .dl_zc_title a").click(function (){
		$("#new_bind").hide();
		$("#old_bind").show();
	});
...
<div id="doc">
	...
	<div id="s_bdw">
		<div id="s_bd">
			...
			<div id="old_bind" class="dl_zc">
				<div class="dl_zc_title">
					<h2 class="f_l">老用户绑定&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:void(0)">新用户请点我</a></h2>
					<div class="rt_bg f_r"></div>
				</div>
				<div class="dl-con" id="regist">
					<form method="post" action="/bind">
						<input type="text" name="third_id" value="${third_id}"/>
						<div class="form">
			...
			<div id="new_bind" class="dl_zc" style="display: none">
				<div class="dl_zc_title">
					<h2 class="f_l">新用户绑定&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:void(0)">老用户请点我</a></h2>
					<div class="rt_bg f_r"></div>
				</div>
				<div class="dl-con" id="regist">
